...
\begin{figure}[h]
  \centering
  \includegraphics[width=\columnwidth]{figures/fig1_detection.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\columnwidth]{figures/fig2_classification.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\columnwidth]{figures/fig3_steering.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\columnwidth]{figures/fig4_compounding.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\columnwidth]{figures/fig5_curriculum.png}
